...
// AQL-10 lyft. Per-patient: blev patienten en responder — HbA1c sjönk efter
// medication_summary mellan första och senaste mätning? Returnerar
// kompositionsdata (first lab, last lab, rx mellan dem) eller tom rad om
// kriterierna inte uppfylls.

export const RESPONDER_AFTER_RX: TemplateDefinition = {
  id: "se.nimloth.aql.responder_after_rx",
  version: "1.0.0",
  title: "HbA1c-förbättring efter läkemedelsinsättning",
  description:
    "Returnerar 1 rad om patienten är responder: sista HbA1c < första HbA1c, med minst en medication_summary-composition mellan mätningarna. Annars tom.",
  parameters: [
    {
      name: "patient_id",
      type: "string",
  ...
  metadata: {
    ...
    sourceAqlId: "AQL-10",
    intent: "Beskriver om HbA1c sjönk efter läkemedelsinsättning (responder-tillstånd). Deskriptivt, ingen åtgärdsrekommendation.",
  },
  aql: `SELECT
